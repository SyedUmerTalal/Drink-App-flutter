...
class CheckoutResponse {
  ...
  factory CheckoutResponse.fromJson(Map<String, dynamic> json) =>
      CheckoutResponse(
        ...
        data: CheckoutModel.fromJson(json['data']),
      );
...
class CheckoutModel {
  ...
  factory CheckoutModel.fromJson(Map<String, dynamic> json) => CheckoutModel(
        ...
        status: json['status'],
        transferCheckoutModel: json['transfer_data'],
  ...
  Map<String, dynamic> toJson() => {
        ...
        'status': status,
        'transfer_data': transferCheckoutModel,
